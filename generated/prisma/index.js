...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/igorkostenevich/Desktop/development/Online store/online_store_BE/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/igorkostenevich/Desktop/development/Online store/online_store_BE/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../.env",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://root:123456@localhost:5433/online-store?schema=public"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"POSTGRES_URI\")\n}\n\nmodel User {\n  id        String   @id @default(cuid())\n  name      String\n  email     String   @unique\n  password  String\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n",
  "inlineSchemaHash": "d73dce944f9d5c04bf0b491a79dc68c590dbe3b05d9caf56a18072f1646e10e5",
  "copyEngine": true
}
